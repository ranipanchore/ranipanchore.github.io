        ...
        <div className="all-projects">
          <div className="project-reverse">
            <div className="project-text">
              ...
              <div className="project-links">
                <a href="https://github.com/ranipanchore/Socialife" target="_blank">
                  Code
          ...
          <div className="project">
            ...
            <div className="project-text">
              ...
              <div className="project-links">
                <a
                  href="https://github.com/ranipanchore/Motorbike-Rental"
                  target="_blank"
                >
                  Code
                  <i class="fa-brands fa-github"></i>
          ...
          <div className="project-reverse">
            <div className="project-text">
              ...
              <div className="project-links">
                <a href="https://github.com/ranipanchore/fitfinity" target="_blank">
                  Code
                  <i class="fa-brands fa-github"></i>
                </a>
                <a
          ...
          <div className="project">
            ...
            <div className="project-text">
              ...
              <div className="project-links">
                <a
                  href="https://github.com/ranipanchore/cryptoverse"
                  target="_blank"
                >
                  Code
                  <i class="fa-brands fa-github"></i>
